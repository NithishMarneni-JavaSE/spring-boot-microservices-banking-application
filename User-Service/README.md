...
This project is actively maintained by Nithish Marneni, a Software Developer with 3+ years of professional experience in technologies like Java, JavaScript, TypeScript, SQL, Spring Boot, Spring Security, and Hibernate.

For questions or contributions, feel free to reach out:
- GitHub: [nithishmarneni](https://github.com/nithishmarneni)
- LinkedIn: [Nithish Marneni](https://www.linkedin.com/in/nithish-marneni/)
